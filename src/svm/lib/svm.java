...
public class svm {
     ...
     */
    //public static String svm_model_dataFileDirPath = gasvm.PropertyUtil.getDirStringPropertis("svm.model.dir", "D:\\work\\svmNew\\svm2.8\\data\\from2.6\\");
    public static String svm_model_dataFileDirPath = gasvm.LearningProperties.svm_model_dir;
	...
	{
		DataOutputStream fp = new DataOutputStream(new FileOutputStream(svm_model_dataFileDirPath + model_file_name));
